...
\section{Conclusion}
For Macros with density sufficient to pass nearly unimpeded through the Moon, and in particular nuclear dense objects such as strange quark nuggets, we have demonstrated that seismological constraints are insufficient to rule them out. Since the Moon (and Earth) preferentially attenuate higher frequency modes, it is unlikely that measuring high frequencies would greatly improve sensitivity to these types of impacts. On the other hand, increasing the lunar seismometer sensitivity to small displacements would allow one to use seismological evidence to rule out high density Macros. That said, it is uncertain whether seismic noise at such small displacements would make Macro impacts indistinguishable from the background.
