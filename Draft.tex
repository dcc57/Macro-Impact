...
\end{align}
\subsection{Isotropic Limit Bound}
In the case of a homogeneous moon, we obtain the following upper bound.
\begin{align}
u\leq\sqrt{\f{\Xi E}{\pi^2\rho k v_p^2 R_\te{Moon}^2}}
\end{align}
This expression is independent of the choice of $n_\te{side}$. For the triangle wave $\sigma_X\leq 4.4\times 10^{-7}\te{\,cm}^2$ is undetectable in the homogeneous limit.
\section{Results}
...
TO BE FINISHED: The author would like to thank SOURCE for supporting this research.
