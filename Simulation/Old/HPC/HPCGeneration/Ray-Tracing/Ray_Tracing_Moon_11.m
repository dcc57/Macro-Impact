...
%INPUTS
D = 1100*10^3; %THE DISTANCE OF CLOSEST APPROACH TO THE CENTER m
...
bs = ([1.08519*10^(-7),1.08519*10^(-7),1.08519*10^(-7),1.08519*10^(-7),1.08519*10^(-7),10^(-11),10^(-11),10^(-11)].*10^(-3)).^(1/2);
...
save PointsTestMat11.mat outputmat;
save PointsTestNum11.mat outputnum;