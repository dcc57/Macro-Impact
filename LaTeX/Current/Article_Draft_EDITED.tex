...
\begin{align}
\scr F =\f{\sum_D D^2\scr F_D}{\sum_D D^2}\,.
\end{align}
...
1-e^{p(1-\f{\Delta x}{d})}\,,
\end{align}
where $p$ describes how the detection probability increases as the strength of signal increases. Requiring that 2 digital units be $n$ times as detectable as 1 digital unit fixes $p = \ln\sqrt n$.
