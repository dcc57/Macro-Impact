...
Hence
\begin{align}
A_x&=\mu\f{(k_y^2-k_z^2)(\Sigma_{yy}-\Sigma_{zz})+k_x^2(\Sigma_{yy}+\Sigma_{zz})}{2k_x^2k^2}\,,\\
&=\mu\f{(k_y^2-k_z^2)(\Sigma_{yy}-\Sigma_{zz})-k_x^2\Sigma_{xx}}{2k_x^2k^2}\,,\\
&=\mu\f{(k_y^2-k_z^2)}{k_x^2}\f{(\Sigma_{yy}-\Sigma_{zz})}{2k^2}-\mu\f{\Sigma_{xx}}{2k^2}\,,\\
\end{align}
By symmetry, we have
\begin{align}
A_x&=\mu\f{(k_y^2-k_z^2)}{k_x^2}\f{(\Sigma_{yy}-\Sigma_{zz})}{2k^2}-\mu\f{\Sigma_{xx}}{2k^2}\,,\\
A_y&=\mu\f{(k_z^2-k_x^2)}{k_y^2}\f{(\Sigma_{zz}-\Sigma_{xx})}{2k^2}-\mu\f{\Sigma_{yy}}{2k^2}\,,\\
A_z&=\mu\f{(k_x^2-k_y^2)}{k_z^2}\f{(\Sigma_{xx}-\Sigma_{yy})}{2k^2}-\mu\f{\Sigma_{zz}}{2k^2}\,.
\end{align}
...
\begin{align}
U_x&=k_y A_z-k_z A_y\,,\\
&=\f{\mu}{2k^2k_y^2k_z^2}\ps{-k_z^3\p{-k_y^2\Sigma_{yy}+(k_x^2-k_z^2)(\Sigma_{xx}-\Sigma_{zz})}+k_y^3\p{(k_x^2-k_y^2)(\Sigma_{xx}-\Sigma_{yy})-k_z^2\Sigma_{zz}}}\,,\\
&=\f{\mu}{2k^2k_y^2k_z^2}\ps{k_z^2k_y^2(k_z\Sigma_{yy}-k_y\Sigma_{zz})-k_z^3(k_x^2-k_z^2)(\Sigma_{xx}-\Sigma_{zz})+k_y^3(k_x^2-k_y^2)(\Sigma_{xx}-\Sigma_{yy})}\,,\\
&=\mu\ps{\f{1}{2k^2}(k_z\Sigma_{yy}-k_y\Sigma_{zz})-\f{k_z(k_x^2-k_z^2)}{2k^2k_y^2}(\Sigma_{xx}-\Sigma_{zz})+\f{k_y(k_x^2-k_y^2)}{2k^2k_z^2}(\Sigma_{xx}-\Sigma_{yy})}\,,\\
\end{align}
Just cyclically permute the indices to obtain the expressions for $U_y$ and $U_z$.
\begin{align}
\f{U_x}{\mu}&=\f{1}{2k^2}(k_z\Sigma_{yy}-k_y\Sigma_{zz})-\f{k_z(k_x^2-k_z^2)}{2k^2k_y^2}(\Sigma_{xx}-\Sigma_{zz})+\f{k_y(k_x^2-k_y^2)}{2k^2k_z^2}(\Sigma_{xx}-\Sigma_{yy})\,,\\
\f{U_y}{\mu}&=\f{1}{2k^2}(k_x\Sigma_{zz}-k_z\Sigma_{xx})-\f{k_x(k_y^2-k_x^2)}{2k^2k_z^2}(\Sigma_{yy}-\Sigma_{xx})+\f{k_z(k_y^2-k_z^2)}{2k^2k_x^2}(\Sigma_{yy}-\Sigma_{zz})\,,\\
\f{U_z}{\mu}&=\f{1}{2k^2}(k_y\Sigma_{xx}-k_x\Sigma_{yy})-\f{k_y(k_z^2-k_y^2)}{2k^2k_x^2}(\Sigma_{zz}-\Sigma_{yy})+\f{k_x(k_z^2-k_x^2)}{2k^2k_y^2}(\Sigma_{zz}-\Sigma_{xx})\,,\\
\end{align}
Assuming cylindrical symmetry, we have $\Sigma=\Sigma_{zz}=-2\Sigma_{xx}=-2\Sigma_{yy}$.
\begin{align}
U_x&=\ps{-(k_z+2k_y)k_x^2k_y^2+3k_zk_x^2(k_x^2-k_z^2)}\f{\mu}{4k^2k_x^2k_y^2}\Sigma\,,\\
U_y&=\ps{(2k_x+k_z)k_x^2k_y^2-3k_zk_y^2(k_y^2-k_z^2)}\f{\mu}{4k^2k_x^2k_y^2}\Sigma\,,\\
U_z&=\ps{(k_x-k_y)k_x^2k_y^2+3(k_x^3-k_y^3)k_z^2+3k_y^5-3k_x^5}\f{\mu}{4k^2k_x^2k_y^2}\Sigma\,.
\end{align}
...
\end{align}
Setting this equal to the earlier $E_{\te{propagated}}$ yields
\begin{align}
\f{h \bar p^2\pi^2r_0^6}{8\Delta r^2\lambda_0^2}&=(\sigma_Xp_0)^2\f{\pi h}{\lambda_0^2}\,,\\
\bar p&=\p{2\sqrt{2\pi}\f{r_X^2\Delta r}{r_0^3}}p_0\,.
\end{align}
We know that shock waves are rapidly attenuated in the earth. Therefore, the estimate of the energy propagated by the initial overpressure serves as an upper bound to the energy propagated during the non-linear phase.
