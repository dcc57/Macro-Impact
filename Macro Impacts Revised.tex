...
Instead of the hypergeometric function, whose form is unnecessarily linked to the profile of the pressure wave, suppose the pressure wave has the Fourier transform
\begin{align}
\f{4\pi p_0}{k\cos\theta}\sin\p{\f{h k\cos\theta}{2}}F(b k\sin\theta)
\end{align}
and write
\begin{align}
F^2 = \sum_{i = 0}^\infty G_i \times (bk\sin\theta)^i\,.
\end{align}
The term $e^{-k\f{Q}{T}}$ tells us at what point we can stop the integral.
\pagebreak
