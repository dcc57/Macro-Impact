...
\end{align}
These are arcs of circles which touch the boundary $r=\f ab$ at right angles. That is, the trajectory of rays is given by geodesics in the Poincare disk. This can be seen easily by inspection of the metric a modified Poincare Disk:
\begin{align}
