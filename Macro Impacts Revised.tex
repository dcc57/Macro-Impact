...
\end{align}
The approximation (32) holds when $bk_0\ll 1$, and is always an overestimate. Since we know $b$ is on the order of meters, this is, in fact, a good approximation. Thus
\begin{align}
...
\end{align}
$A$ is a constant which characterizes the explosion for small $k$. In the case that $f$ is constant, $A = 1$.
\pagebreak
