...
\end{align}
Assuming axial symmetry, we have $\Sigma_{xx}=\Sigma\cos^2\theta$, $\Sigma_{yy}=\Sigma\sin^2\theta$, and $\Sigma_{zz}=-\Sigma$. Hence, 
\begin{align}
E&=\mu\int\f{\diff^3 k}{(2\pi)^3}\Sigma^2\p{\f{\sec^2\theta+\csc^2\theta}{4\mu^2}}\,,\\
&=\f{1}{\mu}\int\f{\diff^3 k}{(2\pi)^3}\Sigma^2\csc^2(2\theta)\,,\\
&=\f{1}{\mu}\int\f{\diff k\diff\theta}{(2\pi)^2}\Sigma^2k^2\csc^2(2\theta)\,.
\end{align}
