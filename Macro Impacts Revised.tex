...
\end{align}
(David, what happened to the factor of $2\pi$?)
...
\begin{align}
T(r,0) = \f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\delta(r),
\end{align}
Then, taking the Fourier transform of this initial condition over r and $\phi$ fixes $C_1$ as 
\begin{align}
C_1 =  2\pi \f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\int_{0}^{\infty}\delta(r)e^{2\pi i k r} dr = 2\pi\f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\,,
\end{align}
where the factor of $2 \pi$ comes from the $\phi$ integral.
$T$ in real space is given by inverting the Fourier transform:
\begin{align}
T(r,t) &= \int_0^\infty k_r \diff{k_r}\tilde{T} = 4\pi^2\f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\int_0^\infty k_r\diff k_r e^{-\alpha k_r^2 t}J_0(k_r r)\,,\\
&=\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha t}\ e^{-\f{r^2}{4t\alpha}}\,.
\end{align}
(I'm not sure about the last equality given that I'm still a bit unclear about the factors of $2\pi$ for the inverse transform as noted above after eq. (300) It would seem there are factors from $C_1$ and $\tilde{T}$.  However, the rest of what follows holds, up to some factors of $2\pi$ that hopefully we can clarify).
Setting $T = T_\te{melt}$, we have
\begin{align}
r_\te{melt} = \sqrt{4t\alpha\ln\ps{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}}}\,.
\end{align}
...
\begin{align}
\dot r_\te{melt} &=\sqrt{\f{\alpha}{t}}\f{\ln\p{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}} - 1}{\sqrt{\ln\p{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}}}}\,.
\end{align}
Since, for the parameters at hand, $\ln\p{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}}$ is at least of order 10 $>>$ 1, it is a good approximation to take
\begin{align}
\dot r_\te{melt} &=\sqrt{\f{\alpha}{t}\ln\p{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}}}\,.
\end{align}
Thus, the time at which the velocity of the melt front is that of the speed of sound is given by using the Lambert W-function (or "ProductLog" in Mathamatica) as
\begin{align}
t_{\te{fast}} = \f{\alpha}{v_p^2}W\p{{\f{\abs{\frac{dE}{dx}v_p^2}}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}}
\end{align}
Plugging in $t_{\te{fast}}$ to $r_\te{melt}$, which is a good approximation in our case, gives
\begin{align}
r_\te{fast melt} =  \frac{2\alpha}{v_p}\sqrt{W\p{{\f{\abs{\frac{dE}{dx}v_p^2}}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}}\ln\ps{\p{\frac{\abs{\frac{dE}{dx}v_p^2}}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}\frac{1}{W\p{{\f{\abs{\frac{dE}{dx}v_p^2}}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}}
}}}\,.
\end{align}
...
\begin{align}
r_\te{fast melt} =\frac{2\alpha}{v_p}W\p{{\f{\abs{\frac{dE}{dx}v_p^2}}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}}.
\end{align}
which is on the order of micrometers to tenths of micrometers for our case.
