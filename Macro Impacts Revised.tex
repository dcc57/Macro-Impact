...
\begin{align}
r_\te{fast melt} =\frac{2\alpha}{v_p}W\p{{\f{\abs{\frac{dE}{dx}}v_p^2}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}} = \frac{2\alpha}{v_p}W\p{\frac{v_{X} v_p^2}{2 c_p \alpha^2 T_\te{melt}}}.
\end{align}
which is on the order of micrometers to tenths of micrometers for our case.
