...
\end{align}
(If the third equation is valid up to some factors of $2\pi$ that I'm too tired to figure out right now, then the rest is valid  but needs to be fixed to include these factors properly).
Setting $T = T_\te{melt}$, we have
\begin{align}
