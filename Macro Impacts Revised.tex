...
\begin{align}
\f{E_m'}{N} &= \f{p_0^2}{N}\f{\lambda_m+2\mu_m}{K_m^2}F_{m,n}^2\int\f{\diff^3 k}{(2\pi)^3}\abs{\f{4\pi p_0}{k\cos\theta}\sin\p{\f{h k\cos\theta}{2}}(b^2f_1(b)-a^2f_1(a))}^2e^{-k\f{T_{m,n}}{Q_{m,n}}}\,,\\
...
\end{align}
$A$ is a constant which characterizes the explosion for small $k$. In the case that $f$ is constant, $A = f\times (b^2-a^2)$. If $f$ is the triangle from section 2, then $A = \f16\Delta r(3r_0 + 2\Delta r)$.
\pagebreak
