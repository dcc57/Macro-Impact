...
\begin{align}
C_1 =  2\pi \f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\int_{0}^{\infty}\delta(r)e^{i k r} dr = 2\pi\f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\,,
\end{align}
where the factor of $2 \pi$ comes from the $\phi$ integral.
$T$ in real space is given by inverting the Fourier transform:
\begin{align}
T(r,t) &=\frac{1}{\p{2\pi}} \int_0^\infty k_r \diff{k_r}\tilde{T} = \frac{2\pi}{2\pi}\f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\int_0^\infty k_r\diff k_r e^{-\alpha k_r^2 t}J_0(k_r r)\,,\\
...
\begin{align}
r_\te{fast melt} =\frac{2\alpha}{v_p}W\p{{\f{r_X\abs{\frac{dE}{dx}}v_p^2}{2 \rho \sigma_x c_p \alpha^2 T_\te{melt}}}} = \frac{2\alpha}{v_p}W\p{\frac{r_Xv_{X} v_p^2}{2 c_p \alpha^2 T_\te{melt}}}.
\end{align}
which is on the order of micrometers to tenths of micrometers for our case.
