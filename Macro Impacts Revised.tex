...
\begin{align}
T(r,t) &=\frac{1}{\p{2\pi}^2} \int_0^\infty k_r \diff{k_r}\tilde{T} = \frac{4\pi^2}{4\pi^2}\f{\abs{\frac{dE}{dx}}}{\rho \sigma_x c_p}\int_0^\infty k_r\diff k_r e^{-\alpha k_r^2 t}J_0(k_r r)\,,\\
