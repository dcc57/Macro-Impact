...
\end{align}
Since, for the parameters at hand, $\ln\p{\f{\abs{\frac{dE}{dx}}}{2 \rho \sigma_x c_p \alpha T_\te{melt} t}}$ is at least of order 10 $>>$ 1, it is a reasonable approximation to take
\begin{align}
