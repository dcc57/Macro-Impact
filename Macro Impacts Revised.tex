...
From symmetry, it is clear that it is enough to understand the behavior of rays from a point source to understand the propagation of rays in the whole sphere. Let $\vec p=(r,\theta)$ denote the position vector of our ray, whose initial coordinates are $\vec p(0)=(z,0)$.
