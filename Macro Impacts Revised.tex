...
\end{align}
Assuming axial symmetry, we have $\Sigma_{xx}=\Sigma\cos^2\theta$, $\Sigma_{yy}=\Sigma\sin^2\theta$, and $\Sigma_{zz}=-\Sigma$. Note that this choice is justified since the full stress tensor is invariant under rotations about the $z$-axis. Hence, 
\begin{align}
...
\begin{align}
E&=\mu\int\f{\diff^3 k}{(2\pi)^3}\Sigma^2k(k_x^2+k_y^2)^{3/2}\p{\f{1}{k_x^2}+\f{1}{k_y^2}}\,.
\end{align}
\end{document}
