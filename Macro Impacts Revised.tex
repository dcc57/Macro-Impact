...
\end{align}
Qualitatively, these appear to be arcs of circles which touch the boundary $r=\f ab$ at right angles. It would be nice to double check this. If that is the case, then this is an instance of rays tracing out geodesics in the Poincare disk.
\pagebreak
